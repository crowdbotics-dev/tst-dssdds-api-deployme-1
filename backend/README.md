...
## Project Structure
    ...
    ├── tst_dssdds_api_deployme_1  # Django project configurations
...
1. Clone this repo and `cd tst_dssdds_api_deployme_1`
...
2. Clone this repo and `cd tst_dssdds_api_deployme_1`
